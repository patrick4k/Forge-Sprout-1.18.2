...
public class ModEntityGeneration {
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        if (event.getCategory() == Biome.BiomeCategory.FOREST) {
            addEntityToAllBiomes(event, ModEntityTypes.MISANTHROPE.get(),10,0,1);
        }
        addEntityToSpecificBiomes(event, ModEntityTypes.MISANTHROPE.get(),20,0,1, Biomes.WARPED_FOREST);
    }
